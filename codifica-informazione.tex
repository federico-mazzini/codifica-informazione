...
Nella stampa e nella pittura i materiali non emettono luce, ma riflettono la luce che li colpisce.
Il colore si ottiene quindi tramite sintesi sottrattiva, perché i pigmenti assorbono una parte della luce e ne riflettono solo una parte. 
...
Di conseguenza, combinando più colori si ottengono colori sempre più scuri, fino a tendere al nero.
...
Come visto nella sintesi additiva, il colore sugli schermi si ottiene sommando luce.  
...
Dal punto di vista informatico (e quindi delle informazioni che i dispositivi digitali codificano), ogni subpixel RGB di un pixel viene rappresentato tramite un numero intero.  
Il colore di un pixel è quindi descritto come una \textbf{tripla di numeri} $(R, G, B)$, che indica quanta luce viene emessa dai subpixel rosso, verde e blu.
...
Spesso i colori RGB vengono spesso scritti in \textbf{notazione esadecimale}.

Essendo che, come visto alle sezioni precedenti 4 bit rappresentano esattamente una cifra esadecimale, per ogni canale R,G, B sono necessari 8 bit (1 byte). La forma generale è quindi la seguente:
\[
\#RRGGBB
\]
Dove:
\begin{itemize}
  \item RR rappresenta il valore del rosso in esadecimale;
  \item GG rappresenta il valore del verde in esadecimale;
  \item BB rappresenta il valore del blu in esadecimale.
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Esercizi -- Codifica dei caratteri e delle immagini}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
