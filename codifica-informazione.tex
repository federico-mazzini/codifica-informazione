...
\item Qual è il minor numero di bit necessari per rappresentare il numero 4356?

\item Un numero scritto in base 4 è $3210_4$. Converti il numero in base 10 mostrando i pesi delle cifre.
...
\item Dato il numero esadecimale $CF79E_{16}$, convertirlo in binario utilizzando la tabella di corrispondenza (pagina 10 dispense). Quanti byte servono per rappresentarlo?.

\item Dato il numero binario 11111100010101000, convertirlo in esadecimale utilizzando la tabella di corrispondenza (pagina 10 dispense).
