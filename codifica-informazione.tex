...
{\Large Il sistema binario ed esadecimale}\\[0.6cm]
...
\subsubsection*{Prefisso 0x}
Quando si scrivono numeri in esadecimale, si usa spesso il prefisso \code{0x} per dichiarare e non lasciare dubbi sulla codifica del numero. Ad esempio \code{0x2A} indica il numero esadecimale 2A.

Il prefisso \code{0x} serve quindi solamente a ricordare che il numero va letto in base 16 e non in base 10.
...
Procedura generale:
\begin{enumerate}
  \item Raggruppare i bit in blocchi da 4 a partire da destra (se necessario si aggiungono zeri a sinistra nel primo blocco);
...
Da tabella:
\[
1111_2 = F_{16}, \quad 0000_2 = 0_{16}, \quad 1010_2 = A_{16}
\]
...
Da tabella:
\[
1000_2 = 8_{16}, \quad 0000_2 = 0_{16}
\]
...
Procedura generale, per ogni cifra esadecimale:
\begin{enumerate}
...
\begin{itemize}
  \item \(7_{16} \rightarrow 0111_2\)
  \item \(B_{16} \rightarrow 1011_2\)
\end{itemize}
